...
namespace MBand.Controllers
{
    public class MembersController : Controller
    {
        ...
        {
            var members = db.Members.Include(m => m.Band).Include(m => m.MemberType);
        ...
        //public ActionResult Create([Bind(Include = "MemberId,FullName,MemberTypeId,BandId,MemberImg")] Member member)
        //{
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Create(Member member, HttpPostedFileBase uploadImage)
        {
